...
def eval_model(n, batch_size=64):
    ...
    model_eval.compile(optimizer=SGD(4e-3),
                  ...
                  loss=BinaryCrossentropy(from_logits=False),
                  metrics=[keras.metrics.Precision(class_id=0), keras.metrics.Recall(class_id=0),
                               keras.metrics.Precision(class_id=1), keras.metrics.Recall(class_id=1),
                               keras.metrics.Precision(class_id=2), keras.metrics.Recall(class_id=2),
                               keras.metrics.Precision(class_id=3), keras.metrics.Recall(class_id=3),
                               keras.metrics.Precision(class_id=4), keras.metrics.Recall(class_id=4),
                               keras.metrics.Precision(class_id=5), keras.metrics.Recall(class_id=5),
                               keras.metrics.Precision(class_id=6), keras.metrics.Recall(class_id=6),
                               keras.metrics.Precision(class_id=7), keras.metrics.Recall(class_id=7),
                               keras.metrics.Precision(class_id=8), keras.metrics.Recall(class_id=8),
                               keras.metrics.Precision(class_id=9), keras.metrics.Recall(class_id=9),
                               keras.metrics.Precision(class_id=10), keras.metrics.Recall(class_id=10),
                               keras.metrics.Precision(class_id=11), keras.metrics.Recall(class_id=11),
                               keras.metrics.Precision(class_id=12), keras.metrics.Recall(class_id=12),
                               keras.metrics.Precision(class_id=13), keras.metrics.Recall(class_id=13),
                               keras.metrics.Precision(class_id=14), keras.metrics.Recall(class_id=14),
                               keras.metrics.Precision(class_id=15), keras.metrics.Recall(class_id=15),
                               keras.metrics.Precision(class_id=16), keras.metrics.Recall(class_id=16)])
